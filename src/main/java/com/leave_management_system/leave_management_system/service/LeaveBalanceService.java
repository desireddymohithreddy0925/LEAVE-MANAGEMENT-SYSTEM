...
public class LeaveBalanceService {
        ...
        public LeaveBalanceResponseDTO createLeaveBalance(LeaveBalanceRequestDTO dto) {
                ...
                leaveBalance.setYear(java.time.Year.now().getValue());
                leaveBalance.setTotal(leaveType.getDefaultDays());
                leaveBalance.setUsed(0);
                leaveBalance.setAvailable(leaveType.getDefaultDays());
        ...
        public LeaveBalanceResponseDTO updateLeaveBalance(
                ...
                leaveBalance.setAvailable(dto.getAvailable());
